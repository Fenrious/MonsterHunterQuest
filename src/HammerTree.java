...
public class HammerTree extends WeaponTree {
    public HammerTree() {
        ...
        baseWeapon.getLeftChild().setLeftChild(new LinkedWeaponTreeNode(new Hammer("Jyuratodus Scale Hammer",
                150, 112, 0, 0), "Jyuratodua"));
        baseWeapon.getLeftChild().setRightChild(new LinkedWeaponTreeNode(new Hammer("Jyuratodus Claw Hammer",
                130, 125, 0, 0), "Jyuratodus"));
